...
export default function DarkMode() {
  const [dark, setDark] = useState(() => {
    try {
      ...
      // Devuelve false si hay un error (ej. permisos)
      return false;
    }
  });

  // Manejador para el cambio del interruptor
  const handleToggle = () => {
  ...
  return (
    <label className="inline-flex items-center relative">
      <input
        ...
        id="toggle"
        type="checkbox"
        // 1. Asigna el estado 'dark' al atributo 'checked'
        checked={dark}
        // 2. Asigna el manejador de eventos
